...
exports.run = async (bot, message, args) => {
  ...
  let kadınRol = message.guild.roles.get('721003971312877638'); // kadın
  let kadınRol1 = message.guild.roles.get('721003971312877638'); // yedek kadın
  let sRol = message.guild.roles.get('721003971312877638'); // erkek
  let sRol1 = message.guild.roles.get('721003971312877638'); // yedek erkek
